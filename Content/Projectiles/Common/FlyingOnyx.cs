...
namespace UniverseOfSwordsMod.Content.Projectiles.Common
{
    public class FlyingOnyx : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.rotation = Utils.AngleLerp(Projectile.rotation, Vector2.Normalize(Projectile.Center - npc.Center).ToRotation() + MathHelper.Pi, 0.2f);
            Timer++;
            if (Main.myPlayer == Projectile.owner && Timer % 25f == 0f)
            {
                ...
                Projectile proj = Projectile.NewProjectileDirect(Projectile.GetSource_FromAI(), Projectile.Center + spawnVel, spawnVel, ProjectileID.BlackBolt, Projectile.damage / 2, 4f, Projectile.owner);
