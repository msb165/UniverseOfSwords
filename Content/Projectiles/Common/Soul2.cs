...
namespace UniverseOfSwords.Content.Projectiles.Common
{
    public class Soul2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<TintableDust1>(), newColor: Color.DeepSkyBlue, Scale: 1.25f);
                dust.scale = 1.25f;
