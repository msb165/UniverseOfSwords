...
namespace UniverseOfSwordsMod.Content.Items.Weapons
{
    public class DiamondSword : ModItem
    {
        ...
        public override void OnHitNPC(Player player, NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Projectile.NewProjectile(target.GetSource_OnHit(target), player.Center + newVel, newVel, ModContent.ProjectileType<DiamondBolt>(), (int)(damageDone * 0.75), hit.Knockback, player.whoAmI);
        }
